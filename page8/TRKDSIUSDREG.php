...
Trading Rules Kontrak Derivatif Stock Index USD Regular </h3>
<br/>
<br>
...
<tr>
	<td width="16%" align="left" ><strong>Aplikasi Penerimaan Nasabah Secara Elektronik dan Online</strong></td>
...
<tr>
	<td height="188" align="left"><p><strong>Dokumen Pemberitahuan Adanya Resiko (Risk  Disclosure) &amp; Perjanjian Pemberian Amanat (Client Agreement)</strong></p></td>
	<td width="49%" align="justify" valign="top" ><p><strong>Dokumen  Pemberitahuan Adanya Risiko:</strong><br>
  Nasabah harus memahami benar risiko  perdagangan ini, oleh karena itu nasabah wajib membaca, menerima dan mengerti  &ldquo;Pernyataan Menerima Pemberitahuan Adanya Risiko&rdquo; yang ada pada &ldquo;Dokumen  Pemberitahuan Adanya Risiko&rdquo;. </p>
	...
	<td width="35%" align="justify" valign="top" ><p><strong>Perjanjian  Pemberian Amanat:</strong></p>
	  <p>Perjanjian yang  disepakati oleh PT. Esandar Arthamas Berjangka dengan nasabah untuk  melakukan transaksi penjualan maupun pembelian kontrak berjangka dengan  ketentuan-ketentuan yang ada pada Dokumen Perjanjian Pemberian Amanat.</p></td>
</tr>
<tr>
	<td align="left"><p><strong>Rekening Terpisah / Segregated Account</strong></p></td>
	<td valign="top" align="justify" colspan="2"><p>Nasabah dapat melakukan setoran dana dalam mata uang USD  sebagai Margin Deposit untuk jaminan Pembukaan <em>Account</em>, dan <em>Additional  Margin </em>(Inject Dana) ke Rekening Segregated PT. Esandar Arthamas Berjangka:</p>
	<pre style="font-family:Arial; font-size:15px">    
   <strong> &rArr;</strong><strong> Bank Central Asia (BCA) Sudirman - Jakarta
</strong>         No. Account: 035.313.4610 (USD)<br>         Atas Nama: PT. Esandar Arthamas Berjangka</pre>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td valign="top" align="justify" colspan="2"><p>Minimum setoran awal untuk new account yang disetor oleh  nasabah untuk dapat melakukan transaksi sebesar : USD. 5.000.- (New Account).</p></td>
</tr>
<tr>
	<td valign="top" width="10%" align="left" ><strong>Rate</strong></td>
	<td valign="top" align="justify" colspan="2">Rate dalam USD</td>
</tr>
<tr>
...
<tr>
	...
	<td valign="top" align="justify" colspan="2">Commission Charge: USD. 50,- / 1 lot settled</td>
</tr>
</table>
<br/>
...
<table cellpadding="5" width="100%" class="tab-rule" border="1">
<tr>
	<td valign="top" width="30%" align="left" ><strong>&nbsp;Jam Perdagangan (GMT+7)</strong></td>
...
<tr>
	<td align="justify" valign="top" colspan="4">
				...
				&diams; Overnight margin Index Saham Hongkong dimulai setelah sesi 2 berakhir dan Index Saham Jepang dimulai pada sesi 2.<br/></td>
</tr>
</table>
<br/>
...
Merupakan Kontrak Index yang diperdagangkan di Jakarta Futures Exchange (JFX) yang mengenal akhir bulan perdagangan.<br/>
...
Merupakan Kontrak Index yang diperdagangkan di Jakarta Futures Exchange (JFX) yang tidak mengenal akhir bulan perdagangan tetapi terdapat Bulan Referensi.
<br/>Pada bulan referensi tersebut akan diadakan penyesuaian untuk open posisi yang masih ada dan
open posisi (Original Price) tetap ada selama belum dilikuidasi nasabah.<br/>
</table>
<br/>
...
<tr>
	...
	<td width="15%" align="center" valign="top"><strong>HONGKONG</strong></td>
	<td width="15%" align="center" valign="top"><strong>JEPANG</strong></td>
	<td width="15%" align="center" valign="top"><strong>KOREA</strong></td>
	<td width="20%" align="center" valign="top"><strong>HONGKONG</strong></td>
	<td width="20%" align="center" valign="top"><strong>JEPANG</strong></td>	
	<td width="15%" align="center" valign="top"><strong>KOREA</strong></td>
</tr>
<tr>
	<td valign="top" align="left"><strong>Code Contract</strong></td>
	<td valign="top" align="center">HKJ5U</td>
	<td valign="top" align="center">JPJ5U</td>
	<td valign="top" align="center">KRJ5U</td>
	<td valign="top" align="center">HKK5U</td>
	<td valign="top" align="center">JPK5U</td>
	<td valign="top" align="center">KRK5U</td>
</tr>
<tr>
	<td valign="top" align="left"><strong>Contract Size</strong></td>
	<td valign="top" align="center">USD 5 </td>
	<td valign="top" align="center">USD 5 </td>
	<td valign="top" align="center">USD 500 </td>
	<td valign="top" align="center">USD 5 </td>
	<td valign="top" align="center">USD 5 </td>
	<td valign="top" align="center">USD 500 </td>
<tr>
...
<tr>
	...
	<td valign="top" align="center">20.0 lot</td>
	<td valign="top" align="center">20.0 lot</td>
	<td valign="top" align="center">20.0 lot</td>
	<td valign="top" align="center">20.0 lot</td>
	<td valign="top" align="center">20.0 lot</td>
...
<tr>
	...
	<td valign="top" align="center">USD 1600 </td>
	<td valign="top" align="center">USD 1600 </td>
	<td valign="top" align="center">USD 1600 </td>
	<td valign="top" align="center">USD 1600 </td>
	<td valign="top" align="center">USD 1600 </td>
...
<tr>
	...
	<td valign="top" align="center">USD 100 </td>
	<td valign="top" align="center">USD 100 </td>
	<td valign="top" align="center">USD 100 </td>
	<td valign="top" align="center">USD 100 </td>
	<td valign="top" align="center">USD 100 </td>
...
<tr>
	...
	<td valign="top" align="center">USD 320 </td>
	<td valign="top" align="center">USD 320 </td>
	<td valign="top" align="center">USD 320 </td>
	<td valign="top" align="center">USD 320 </td>
	<td valign="top" align="center">USD 320 </td>
...
<tr>
	...
	<td valign="top" align="center">-</td>
	<td valign="top" align="center">-</td>
	<td valign="top" align="center">USD 2 </td>
	<td valign="top" align="center">USD 2 </td>
	<td valign="top" align="center">USD 2 </td>
</tr>
<tr>
	...
	<td valign="top" align="center">-</td>
	<td valign="top" align="center">-</td>
	<td valign="top" align="center">USD 1 </td>
	<td valign="top" align="center">USD 1 </td>
	<td valign="top" align="center">USD 1 </td>
</tr>
<tr>
...
<tr>
	...
	<td valign="top" align="justify" colspan="3">Automatic Rollover (Lihat Ketentuan Tambahan untuk Kontrak Berkala (Rollover Contract))</td>
</tr>
<tr>
	<td height="50" align="left"><strong>KALKULASI: Profit/Loss</strong></td>
	<td valign="top" align="center" colspan="3"><p><strong>&#9658;</strong><strong>HKJ5U; JPJ5U; KRJ5U:</strong></p>
	  <p>(SELL&ndash; BUY) x lot x contract size</p></td>
	<td valign="top" align="center" colspan="3"><p><strong>&#9658;</strong><strong>HKK5U; JPK5U; KRK5U:</strong></p>
	  <p>(SELL&ndash; BUY) x lot x contract size</p></td>;
</tr>
</table>
...
<tr>
	...
	<td valign="top" align="justify" colspan="2">
	  <p>Beda antara Angka Penyelesaian kedua bulan kontrak itu pada akhir hari sebelumnya Hari Ganti Bulan<br/>
	    Referensi tidak diperhitungkan sebagai laba atau rugi tetapi dilakukan penyesuaian.<br/>
	    <br/>
	    ...
	    Open posisi Sell:<br/>
	    Penyesuaian = (Harga Closing Kontrak Baru – Harga Closing Kontrak Lama) x Contract Size x Lot<br/>
	    <br/>
	    
	    Open posisi (original price) tetap ada selama belum dilikuidasi oleh nasabah.<br/>
      </p>
	  </td></tr>
...
Penyesuaian<br/> 
= (22600-22625) x USD 5 x 1<br/>
= - USD125<br/>
<br/>

<strong>Contoh:</strong><br/>
Nasabah C Buy HKK5U 1 Lot;<br/>
<br/>
...
Penyesuaian<br/> 
= (22625-22600) x USD 5x 1<br/>
= USD 125<br/>
<br/>

<strong>Contoh:</strong><br/>
Nasabah D Sell HKK5U 1 Lot;<br/>
<br/>
...
<tr class="top">
	...
	<td width="25%" align="center" valign="top"><strong>Stock Index Korea</strong></td>
</tr>
<tr>
<td valign="top" align="justify"><table>
<tr>
...
<tr>
	...
	Harga yang tampil di luar jam transaksi tidak berlaku.
	Apabila terjadi error pada Sistem, Konfirmasi Pending Order akan diputuskan oleh 
...
<tr>
	...
	<td align="justify">Dalam melakukan transaksi, nasabah membutuhkan margin tambahan 
				...
				dalam account nasabah apabila dana telah <em><strong>good fund</strong></em>.<br/>
				<br></td>
	<td align="justify" valign="top">Apabila equity nasabah tidak mencukupi
...
<tr>
	<td height="297" align="left"><strong>Lain-Lain(Miscellaneous)</strong></td>
...
<tr>
<td valign="top">4.</td><td align="justify"> Open Gap berlaku untuk semua produk futures maupun rollover. Apabila selisih harga closing market hari sebelumnya ke harga open market sesi I hari berikutnya melebihi open gap kontraknya, maka semua posisi open pada overnight akan dihedge secara otomatis oleh Sistem. Atas keuntungan maupun kerugian yang timbul karena Open Gap tersebut menjadi hak atau tanggungjawab nasabah sepenuhnya.</td>
</tr>
<tr>
<td></td><td align="justify"> Waktu yang digunakan pada sistem adalah GMT + 2.</td>
</tr>
<tr>
<td valign="top">5.</td><td align="justify"> Trading Rules ini dapat diubah dan akan diberitahukan kepada nasabah melalui Surat Pemberitahuan</td>
</tr>
<tr>
<td valign="top">6.</td><td align="justify"> Platform Esandar Trader dilaksanakan melalui Sistem Elektronik, karena itu nasabah dapat menghadapi risiko yang berkaitan dengan Sistem tersebut. Kegagalan dengan perangkat keras atau perangkat lunak atau <u><strong>terganggunya koneksi internet berakibat tidak dapat dilaksanakan sesuai dengan perintah nasabah.</strong></u></td>
</tr>
<tr>
<td valign="top"></td><td align="justify"> <strong>Apabila terjadi kondisi sebagaimana yang disebutkan diatas, maka order / perintah nasabah dilaksanakan dengan menggunakan telepon ke kantor pusat PT. Esandar Arthamas Berjangka (021-29339318) disertai Phone Password</strong>.</td>
</tr></table></td>
</tr>
<tr>
...
Yang dimaksud dengan kondisi hectic apabila dipenuhi minimal salah satu dari situasi sebagai berikut:<br/><br/>
<table>
<tr>
...
<tr>
	<td height="145" align="left"><strong>PENYELESAIAN PERSELISIHAN</strong></td>
	<td align="left"colspan="3"><table>
<tr>
...
<form onSubmit="return validateForm()" method='post' action='functionsiusdreg.php'>
