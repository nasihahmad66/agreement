...
$pdf->MultiCell(72, 40,'Nasabah harus menutup semua posisinya yang terbuka pada saat waktu kontrak berakhir (expired). Tidak ada Roll Over secara otomatis. Apabila Nasabah belum melikuidasi posisinya yang terbuka pada saat waktu kontrak berakhir, maka Sistem Esandar Trader akan melikuidasi posisi yang terbuka secara otomatis (dengan harga closing market pada Platform Esandar Trader untuk kontrak tersebut)', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(68, 40,'Automatic Rollover (Lihat Ketentuan Tambahan untuk Kontrak Berkala (Rollover Contract))', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();

$pdf->MultiCell(40, 9,'KALKULASI: Profit/Loss', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(72, 9,'HKJ5U; JPJ5U; KRJ5U:
(SELL-BUY) X lot X contract size', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(68, 9,'HKK5U; JPK5U; KRK5U:
(SELL-BUY) X lot X contract size', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln(5);
$pdf->Ln(5);
$pdf->Ln(5);
