...
<tr>
	...
	<li>Bank CCB Indonesia (China Construction Bank Indonesia) - Rawamangun</strong>
...
$table1='<table cellpadding="5" width="100%" class="tab-rule" border="1">
<tr>
	<td valign="top" width="33.3%" align="left" ><strong>Jam Perdagangan (GMT + 7)</strong></td>
	<td align="center" width="66.6%" valign="top"><strong>09:30 - 17:30</strong></td>
...
$pdf->writeHTMLCell(182, '', 14, 58.8,$table2, 0, 0, 0, true, 'J', true);
...
$pdf->writeHTMLCell(182, '', 14, 90.5,$table3, 0, 0, 0, true, 'J', true);
...
$pdf->writeHTMLCell(182, '', 14, 115.7,$table3, 0, 0, 0, true, 'J', true);
$pdf->AddPage();
$pdf->Image('draft3.png', 30, 50, 150, 150, 'PNG', '', '', true, 150, '', false, false, 0, false, false, false);
