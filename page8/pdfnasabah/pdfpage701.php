...
Kami yang mengisi perjanjian di bawah ini:",'',0,'L',true,0, false, false, 0);
	...
	$pdf->MultiCell(8,90,'(2)
	
	
	', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
	$pdf->MultiCell(115,90,'Semua uang, harus disetor atau ditransfer langsung oleh Nasabah ke Rekening Terpisah (Segregated Account) Pialang Berjangka:
...
No. Rekening Terpisah : 100-7585-388 (Rupiah)
	...
	$pdf->MultiCell(0,90,'saya sudah membaca dan memahami
