...
Nasabah harus memahami benar risiko perdagangan ini, oleh karena itu nasabah wajib membaca, menerima dan mengerti Pernyataan Menerima Pemberitahuan Adanya Risiko yang ada pada Dokumen Pemberitahuan Adanya RisikoԮ 
...
$pdf->SetFont('helvetica', 'B', 10);
$pdf->MultiCell(45, 0, 'Rekening Terpisah / Segregated Account
...
->	Bank CCB Indonesia (China Construction Bank Indonesia)-Rawamangun
...
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(135, 0, 'Commission Charge: IDR. 500.000,- / 1 lot settled                                                 ', 1, 'L', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->Ln(0);
$pdf->MultiCell(180, 0, '1. Maksimal Open Posisi Dalam 1 Account 30 LOT
...
5. Overnight margin Index Saham Hongkong dimulai setelah sesi 2 berakhir dan Index Saham Jepang dimulai pada sesi 2.
...
->	Kontrak Berjangka (Stock Index Futures)
    Merupakan Kontrak Index yang diperdagangkan di Jakarta Futures Exchange (JFX) yang mengenal akhir
    bulan perdagangan. Pada akhir bulan perdagangan tersebut posisi nasabah harus terlikuidasi (Clear Posisi).

->	Kontrak Berkala (Stock Index Rollover)
    Merupakan Kontrak Index yang diperdagangkan di Jakarta Futures Exchange (JFX) yang tidak mengenal akhir
    bulan perdagangan tetapi terdapat Bulan Referensi. Pada bulan referensi tersebut akan diadakan penyesuaian
    untuk open posisi yang masih ada dan open posisi (Original Price) tetap ada selama belum dilikuidasi nasabah.
', 1, 'L', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(5);
$pdf->SetFont('helvetica', 'B', 10);
$pdf->MultiCell(45, 0, '                                ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(70, 0, 'Stock Index Futures', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(65, 0, 'Stock Index Rollover', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 0, '                                ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 0, 'HONGKONG', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'JEPANG', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'KOREA', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'HONGKONG', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'JEPANG', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'KOREA', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 0, 'Code Contract', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 0, 'HKJ50', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'JPJ30', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'KRJ35', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'HKK50', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'JPK50', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'KRK35', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 9, 'Contract Size', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 9, 'Rp. 50.000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 9, 'Rp. 30.000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 9, 'Rp. 3.500.000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 9, 'Rp. 50.000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 9, 'Rp. 50.000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 9, 'Rp. 3.500.000,-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 0, 'Normal Spread', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 0, '10', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, '10', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, '0.10 ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, '10', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, '10', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, '0.10 ', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(23, 0, '5 pip', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, '0.05 ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, '1 pip', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, '5 pip', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, '0.05', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 9, 'Maximal Volume (Day Trade)', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 9, '20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 9, '20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 9, '20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 9, '20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 9, '20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 9, '20 lot', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 13.4, 'Margin Requirement per 1 lot DayTrade:', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 0, 'Rp. 5.000.000,-                ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'Rp. 6.000.000,-                ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'Rp. 3.500.000,-                ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'Rp. 5.000.000,-                ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'Rp. 5.000.000,-                ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'Rp. 3.500.000,-                ', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 13.4, 'Margin Requirement per 1 lot Overnight: ', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 13.4, 'Rp. 16.000.000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 13.4, 'Rp. 15.000.000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 13.4, 'Rp. 18.200.000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 13.4, 'Rp. 16.000.000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'Rp. 16.000.000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'Rp. 18.200.000,-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 13.4, 'Margin Hedged Day Trade per 1 lot', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 0, 'Rp. 1.000.000,-                  ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'Rp. 1.200.000,-                  ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'Rp. 700.000,-                    ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'Rp. 1.000.000,-                  ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'Rp. 1.000.000,-                  ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'Rp. 700.000,-                    ', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 13.4, 'Margin Hedged Overnight per 1 lot', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 0, 'Rp. 3.200.000,-               ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'Rp. 3.000.000,-               ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'Rp. 3.640.000,-                ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'Rp. 3.200.000,-               ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'Rp. 3.200.000,-               ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'Rp. 3.640.000,-                ', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 9, 'Swap Buy /1 lot', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 9, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 9, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 9, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'Rp 20.000,-      ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'Rp 20.000,-      ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'Rp 20.000,-      ', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 9, 'Swap Sell / 1 lot', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 9, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 9, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 9, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, 'Rp 10.000,-      ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'Rp 10.000,-      ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, 'Rp 10.000,-      ', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 0, 'Open Gap', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 0, '300 poin', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, '300 poin', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, '500 poin', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, '300 poin', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, '300 poin', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 0, '500 poin', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 74, 'Bulan Kontrak', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 74, 'F = Januari
G = Februari
H = Maret
J = April
K = Mei
...
Z = Desember
                                                                                                                                                                                              ', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 74, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 74, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 74, '-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 30, 'Transaksi Bulan Berikutnya', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 30, 'Dua hari sebelum hari Perdagangan Terakhir', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 30, 'Dua hari sebelum hari Perdagangan Terakhir', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 30, 'Dua hari sebelum hari Perdagangan Terakhir', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 30, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 30, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 30, '-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 40, 'Hari Perdagangan Terakhir
(Hanya untuk melikuidasi posisi)', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 40, 'Satu hari sebelum hari Perdagangan Terakhir Bulan Kontrak dan hanya untuk melikuidasi posisi.', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 40, 'Minggu Kedua Bulan Kontrak,  dan hanya untuk melikuidasi posisi.', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 40, 'Minggu Kedua Bulan Kontrak,  dan hanya untuk melikuidasi posisi.', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 40, 'Tidak ada hari perdagangan Terakhir', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 40, 'Tidak ada hari perdagangan Terakhir', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 40, 'Tidak ada hari perdagangan Terakhir', 1, 'J', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 66.4, 'Penyesuaian Akibat Ganti Bulan Referensi', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
...
Open posisi Buy: 
Penyesuaian = 
(Harga Closing Kontrak Lama - Harga Closing Kontrak Baru) x Contract Size x Lot

Open posisi Sell: 
Penyesuaian = 
(Harga Closing Kontrak Baru - Harga Closing Kontrak Lama) x Contract Size x Lot

Open posisi (original price) tetap ada selama belum dilikuidasi oleh nasabah.', 1, 'J', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 40, ' ', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(67.5, 0, 'Contoh:
...
= Rp 5.000.000', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(67.5, 0, 'Contoh:
...
=  Rp 5.000.000', 1, 'J', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(135, 0, '1.	Pada saat Market Hectic, harga Bid / Ask yang ada di Platform tergantung pada
    Market 
2.	Harga yang tampil di luar jam transaksi tidak berlaku.
3.	Apabila terjadi wrong quote (wrong price) pada Platform Esandar Trader, maka
    order yang terjadi pada harga wrong quote dinyatakan tidak berlaku (batal), dan
    akan dibatalkan secara otomatis, tanpa adanya pemberitahuan terlebih dahulu.
4.	Open Gap berlaku untuk semua produk futures maupun rollover. Apabila selisih
    harga closing market hari sebelumnya ke harga open market sesi I hari berikutnya
    melebihi open gap kontraknya, maka semua posisi open pada overnight akan 
    dihedge secara otomatis oleh Sistem. Atas keuntungan maupun kerugian yang 
    timbul karena Open Gap tersebut menjadi hak atau tanggungjawab nasabah
    sepenuhnya.
...
6.	Trading Rules ini dapat diubah dan akan diberitahukan kepada nasabah melalui
    Surat Pemberitahuan.
7.	Platform Esandar Trader dilaksanakan melalui Sistem Elektronik, karena itu
    nasabah dapat menghadapi risiko yang berkaitan dengan Sistem tersebut.
    Kegagalan dengan perangkat keras atau perangkat lunak atau terganggunya
    koneksi internet berakibat tidak dapat dilaksanakan sesuai dengan perintah
    nasabah.
...
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(135, 0, '1.	Nasabah dapat mengakses Laporan Keuangannya (Daily Statement) secara 
    langsung, baik itu Laporan Keuangan hasil transaksi nasabah secara otomatis
    akan terekam di sistem Esandar Trader secara online atau dapat mengakses
    Laporan Transaksi yang dilakukan di hari sebelumnya yang dikirimkan secara
    otomatis ke email nasabah.
2.	Nasabah harus mereview dan melaporkan dengan segera kesalahan-kesalahan
    yang terdapat pada laporan yang tersedia didalam Sistem Esandar Trader.
3.	Segala pelaporan dalam Sistem tersebut akan dianggap telah disetujui apabila
    PT. Esandar Arthamas Berjangka tidak menerima pemberitahuan melalui telepon
    dan disusul pada pemberitahuan tertulis selambat-lambatnya 2 (dua) hari kerja
    dari tanggal Laporan Keuangan nasabah tersebut.
4.	Bilamana dalam waktu 2 (dua) hari kerja sejak tanggal Laporan Keuangan
    nasabah tersebut dikeluarkan tidak ada sanggahan dari nasabah atau
    pemberitahuan kepada PT. Esandar Arthamas Berjangka atas setiap kesalahan
    akan mengakibatkan nasabah menerima Laporan Keuangan tersebut seperti yang
    tertulis didalamnya maka Laporan Keuangan nasabah tersebut dianggap benar
    dan sah.', 1, 'L', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(135, 0, '1.	Pembuktian atas fakta-fakta, di mana fakta-fakta tersebut dapat dilihat antara lain 
    di dalam historis transaksi, report, dan data-data pendukung lainnya.
2.	Mengacu pada data-data terakhir yang tercatat di PT. Esandar Arthamas
    Berjangka dan sesuai dengan ketentuan - ketentuan yang ada di dalam Trading 
    Rules.
...
$pdf->MultiCell(10, 0, $form808['Menerima'], 0, 'L', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(2);
$pdf->MultiCell(70, 0, 'Menyatakan pada Tanggal', 0, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(5, 0,':', 0, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(40, 0, $form808['tanggal'], 0, 'L', 0, 1, '', '', true, 0, false, true, 0);
$pdf->Ln(5);
