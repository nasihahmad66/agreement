...
$pdf->MultiCell(40, 50,'Rekening Segregated
...
$pdf->MultiCell(0, 50, 'Nasabah dapat melakukan setoran dana dalam mata uang Rupiah dan US Dollar sebagai Margin Deposit untuk jaminan Pembukaan Account, dan Additional Margin (Inject Dana) ke Rekening Segregated PT. Esandar Arthamas Berjangka:
...
$pdf->MultiCell(22, 18,'MAJOR RATE', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 18,'Contract Size', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 18,'Minimum Tick Value', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 18,'Normal Spread', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 18,'Maximum Volume New Open Position', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(35, 18,'Margin Requirement per 0,1 lot Day Trade / Overnight :', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(0, 18,'Margin Hedged per 0,1 lot ', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(22, 0,'5 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(35, 0,'USD. 100.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(0, 0,'USD 20,-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(22, 0,'0.0001', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.03', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'5 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(35, 0,'USD. 100.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(0, 0,'USD 20,-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(0, 0,'USD 30,-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(22, 8,'5 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(35, 8,'USD. 100.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(0, 8,'USD 20,-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);
$pdf->SetFont('Helvetica','','10');
...
3. Segala pelaporan dalam Sistem tersebut akan dianggap telah disetujui apabila PT. Esandar   Arthamas Berjangka tidak menerima pemberitahuan melalui telepon dan disusul pada 
