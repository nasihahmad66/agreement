...
$pdf->MultiCell(40, 31,'Rekening Terpisah / Segregated Account 
...
$pdf->MultiCell(0, 0, 'Commission Charge: USD. 5,- / 0.1 lot settled', 1, 'L', 0, 1, '', '', true, 0, false, true, 0);
$pdf->Ln(5);

$pdf->Image('draft3.png', 30, 50, 150, 150, 'PNG', '', '', true, 150, '', false, false, 0, false, false, false);
$pdf->SetFont('times', 'B', 10);
$pdf->MultiCell(92, 0,'Jam Perdagangan (GMT+7)', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(44, 0,'Sesi 1', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(44, 0,'Sesi 2', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();

$pdf->SetFont('times', '', 10);
$pdf->MultiCell(92, 0,'Stock Index Hongkong', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(44, 0,'08:15 - 11:00', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(44, 0,'12:00 - 15:30', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();

$pdf->MultiCell(92, 0,'Stock Index Jepang', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(44, 0,'06:30 - 13:25', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(44, 0,'14:15 - 01:00', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();

$pdf->MultiCell(92, 0,'Stock Index Korea', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(44, 0,'07:00 - 13:35', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(44, 0,'', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();
...
3. DQ menggunakan telepon akan dikenakan spread 10. Ketentuan ini tidak berlaku untuk 5 menit pertama dan pada saat 
				kondisi server sedang mengalami gangguan teknis.(Down)
4. Overnight margin Index Saham Hongkong dimulai setelah sesi 2 berakhir dan Index Saham Jepang dimulai pada sesi 2.', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln(5);
$pdf->Ln(5);
$pdf->Ln(5);
$pdf->Ln(5);
...
$pdf->MultiCell(70, 0,'Stock Index Rollover', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();

$pdf->MultiCell(35, 0,'', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'HONGKONG', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(25, 0,'JEPANG', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 0,'KOREA', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();
...
$pdf->MultiCell(25, 0,'HKK5U', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'JPK5U', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 0,'KRK5U', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();

$pdf->MultiCell(35, 0,'Contract Size/1 lot', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'USD 5', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'USD 5', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'USD 500', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'USD 5', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'USD 5', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 0,'USD 500', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();
...
$pdf->MultiCell(25, 0,'10', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'10', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 0,'0.1', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();
...
$pdf->MultiCell(25, 0,'1 pip', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'5 pip', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 0,'0.05', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();

$pdf->MultiCell(35, 9,'Maximum Volume New Open Position', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9,'5 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9,'5 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9,'5 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9,'5 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9,'5 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 9,'5 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();

$pdf->MultiCell(35, 9,'Max Open Position (0.1 lot)', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(145, 9,'20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();

$pdf->MultiCell(35, 9,'Margin Requirement per 0,1 lot Day Trade:', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9,'USD 50', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9,'USD 50', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9,'USD 50', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9,'USD 50', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9,'USD 50', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 9,'USD 50', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();
...
$pdf->MultiCell(25, 9,'USD 160', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9,'USD 160', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 9,'USD 160', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();
...
$pdf->MultiCell(25, 9,'USD 10', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9,'USD 10', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 9,'USD 10', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();
...
$pdf->MultiCell(25, 9,'USD 32', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9,'USD 32', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 9,'USD 32', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();

$pdf->MultiCell(35, 0,'Swap Buy /0.1 lot', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'- ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'USD 0.2', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'USD 0.2', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 0,'USD 0.2', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();

$pdf->MultiCell(35, 0,'Swap Sell / 0.1 lot', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'USD 0.1', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'USD 0.1', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 0,'USD 0.2', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();
...
$pdf->MultiCell(25, 0,'300 poin', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'300 poin', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 0,'300 poin', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();

$pdf->MultiCell(35, 53.2,'Bulan Kontrak', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
...
U = September
Z = Desember', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 53.2,'-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 53.2,'-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 53.2,'-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();

$pdf->AddPage();
$pdf->Image('draft3.png', 30, 50, 150, 150, 'PNG', '', '', true, 150, '', false, false, 0, false, false, false);

$pdf->MultiCell(35, 18,'Transaksi Bulan Berikutnya', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'Dua hari sebelum hari Perdagangan Terakhir', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'Dua hari sebelum hari Perdagangan Terakhir', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0,'Dua hari sebelum hari Perdagangan Terakhir', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 18,'-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 18,'-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 18,'-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();

$pdf->MultiCell(35, 35.5,'Hari Perdagangan Terakhir(Hanya untuk melikuidasi posisi)', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(25, 35.5,'Minggu Kedua Bulan Kontrak,  dan hanya untuk melikuidasi posisi.', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 35.5,'Tidak ada hari perdagangan Terakhir', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 35.5,'Tidak ada hari perdagangan Terakhir', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 35.5,'Tidak ada hari perdagangan Terakhir', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln();

$pdf->MultiCell(35, 40,'Roll Over', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(35, 9,'KALKULASI: Profit/Loss', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(40, 146,'Penyesuaian Akibat Ganti Bulan Referensi', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(46.7, 0,'1. Pending Order 
			dapat dipasang pada setiap 
			sesi.
2. Pending Order secara 
			otomatis kan berakhir pada 
...
2. Pending Order secara 
				...
				akhir sesi 1 dan 2.', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(46.7, 22.3,'1. Pending Order 
				dapat dipasang pada setiap 
				sesi.
2. Pending Order secara 
				otomatis akan berakhir pada 
...
$pdf->MultiCell(40, 35.5,'PENYELESAIAN PERSELISIHAN', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(50,0,': '.$form805['Menerima'], 0, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln(5);

$pdf->MultiCell(50,0,'Menyatakan pada Tanggal', 0, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Multicell(50,0,': '.$form805['tanggal'], 0, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Ln(5);
