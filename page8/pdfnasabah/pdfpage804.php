...
$pdf->MultiCell(40, 88.4, 'Dokumen Pemberitahuan Adanya Resiko (Risk Disclosure) & Perjanjian Pemberian Amanat (Client Agreement)', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(70, 88.4, 'Dokumen Pemberitahuan Adanya Risiko:
...
$pdf->MultiCell(70, 88.4, 'Perjanjian Pemberian Amanat:
...
$pdf->MultiCell(40, 48.7,'Rekening Segregated
...
$pdf->MultiCell(70, 0,'Winter Time', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(70, 0,'Summer Time', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->MultiCell(40, 0,'MAJOR & CROSS RATE', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(70, 0,'Senin buka pada jam 05:05 dan tutup pada hari sabtu jam 05:00', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(70, 0,'Senin buka pada jam 04:05 dan tutup pada hari sabtu jam 04:00', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->MultiCell(40, 9,'LOCO LONDON GOLD', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(70, 0,'Senin buka pada 06.05 dan Sabtu tutup pada jam 05.00', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(70, 0,'Senin buka pada jam 05.05 dan sabtu tutup pada jam 04.00', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->MultiCell(40, 0,'Waktu istirahat pada time trading LOCO LONDON GOLD', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(70, 13.5,'05.00 sampai jam 06.00 (Setiap Hari)', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(70, 13.5,'04.00 sampai jam 05.00 (Setiap Hari)', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);
$pdf->Ln(4);
	
$pdf->MultiCell(22, 14,'MAJOR RATE', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 14,'Contract Size', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 14,'Minimum Tick Value', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 14,'Normal Spread', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 14,'Maximum Volume', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(35, 14,'Margin Requirement per 1 lot Day Trade / Overnight :', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(0, 14,'Margin Hedged per 1 lot', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->SetFont('Helvetica','','8');
$pdf->MultiCell(22, 0,'EURUSD', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,' 100,000.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.00001', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.00025', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(35, 0,'USD. 1000.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(0, 0,'USD 200,-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->MultiCell(22, 0,'USDJPY', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'$100,000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.001', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.025', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(35, 0,'USD. 1000.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(0, 0,'USD 200,-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->MultiCell(22, 0,'GBPUSD', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,' 100,000.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.00001', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.00025', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(22, 0,'USDCHF', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'$ 100,000', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.00001', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.00025', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(22, 0,'AUDUSD', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'AUD 100,000.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.00001', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.00025', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(35, 0,'USD. 1000.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(22, 0,'CROSS RATE', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(22, 0,'EURJPY', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'EUR 100,000.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.001', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.03', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(35, 0,'USD.1000.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(0, 0,'USD 200,-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->MultiCell(22, 0,'GBPJPY', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'GBP 100,000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.001', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.03', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(35, 0,'USD. 1000.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(22, 0,'AUDJPY', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'AUD 100,000.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.001', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.03', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(22, 0,'CHFJPY', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'CHF 100,000.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.001', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.03', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(35, 0,'USD. 1000.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(22, 0,'EURGBP', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'EUR 100,000', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.00001', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'0.0003', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 0,'20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(35, 0,'USD. 1500.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(0, 0,'USD 300,-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->MultiCell(0, 0,'         ', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->MultiCell(22, 11,'LOCO LONDON GOLD', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 11,'', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 11,'', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 11,'', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 11,'', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(35, 11,'', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(0, 11,'', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->MultiCell(22, 8,'XAUUSD', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 8,'100 Troy Ounce', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 8,'USD 0.01', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 8,'USD 1', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(22, 8,'20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(35, 8,'USD. 1000.-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(0, 8,'USD 200,-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->SetFont('Helvetica','','10');
$pdf->MultiCell(0, 0,'- Maksimal Open Posisi Dalam 1 Account 30 LOT
...
$pdf->SetFont('Helvetica','B','10');
$pdf->MultiCell(30, 22.5,'Interest Rate / Swap', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->SetFont('Helvetica','','10');
...
$pdf->SetFont('Helvetica','B','10');
$pdf->MultiCell(30, 53,'Margin Tambahan & Penarikan Dana (Margin Inject & Withdrawal)', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->SetFont('Helvetica','','10');
...
1. Dana yang dapat ditarik tidak dapat melebihi dari Free Margin yang ada di platform Esandar Trader.
2. Penarikan dana yang diterima sebelum jam 12:00 wib akan dibayar pada hari yang sama (T+0).
3. Penarikan dana yang diterima setelah jam 12:00 wib akan dibayar pada hari berikutnya (T+1).', 1, 'L', 0, 1, '', '', true, 0, false, true, 0);

$pdf->SetFont('Helvetica','B','10');
$pdf->MultiCell(30, 0,'Level / Spread Pending order(Limit Order(LO) / Stop Order(SO))', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->SetFont('Helvetica','','10');
$pdf->MultiCell(150, 22.3,'Level / Spread antara harga yang diminta dan harga running adalah minimum 150 poin dari harga running untuk harga Forex dan Cross Rate, sedangkan untuk Loco London Gold sebesar USD 2.', 1, 'L', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->SetFont('Helvetica','B','10');
$pdf->MultiCell(30, 22.3,'Expiration Pending Order', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->SetFont('Helvetica','','10');
$pdf->MultiCell(150, 0,'Expiration (masa berlaku ) Pending Order untuk Limit, stop, TP, SL adalah Good Till Friday (GTF).Jika Market Holiday (Libur) atau jam trading closing lebih awal maka semua Pending Order untuk new position dan liquidation position akan dicancel secara automatis oleh system setelah market closed. Apabila terjadi error pada Sistem, Konfirmasi Pending Order akan diputuskan oleh PT. Esandar Arthamas Berjangka.', 1, 'L', 0, 1, '', '', true, 0, false, true, 0);
...
B. Short Margin untuk posisi Overnight
				...
				saat market close setiap hari Jumat 
...
$pdf->SetFont('Helvetica','B','10');
$pdf->MultiCell(30, 53,'Keadaan Hectic Market', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->SetFont('Helvetica','','10');
...
$pdf->SetFont('Helvetica','B','10'); 
$pdf->MultiCell(30, 66.4,'Lain-Lain         (Miscellaneous)', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->SetFont('Helvetica','','10');
...
$pdf->MultiCell(90,0,': '.$form804['Menerima'], 1, 'L', 0, 1, '', '', true, 0, false, true, 0);

$pdf->MultiCell(90,0,'Menyatakan pada Tanggal', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->Multicell(90,0,': '.$form804['tanggal'], 1, 'L', 0, 1, '', '', true, 0, false, true, 0);
$pdf->Ln(5);
