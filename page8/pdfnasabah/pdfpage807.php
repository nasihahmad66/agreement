...
$pdf->MultiCell(25, 9, '20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9, '20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9, '20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9, '20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 9, '20 lot', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 9, '20 lot', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(25, 0, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0, 'Rp 2000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0, 'Rp 2000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 0, 'Rp 2000,-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(25, 0, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0, 'Rp 1000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 0, 'Rp 1000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 0, 'Rp 1000,-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(35, 58, 'Bulan Kontrak', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 58, 'F = Januari
G = Februari
H = Maret
J = April
K = Mei
...
U = September
Z = Desember', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 58, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 58, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 58, '-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(35, 18, 'Transaksi Bulan Berikutnya', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 18, 'Dua hari sebelum hari Perdagangan Terakhir', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 18, 'Dua hari sebelum hari Perdagangan Terakhir', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 18, 'Dua hari sebelum hari Perdagangan Terakhir', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 18, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 18, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 18, '-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(35, 36, 'Hari Perdagangan Terakhir
(Hanya untuk melikuidasi posisi)', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 36, 'Satu hari sebelum hari Perdagangan Terakhir Bulan Kontrak dan hanya untuk melikuidasi posisi.', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 36, 'Minggu Kedua Bulan Kontrak,  dan hanya untuk melikuidasi posisi.', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 36, 'Minggu Kedua Bulan Kontrak,  dan hanya untuk melikuidasi posisi.', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 36, 'Tidak ada hari perdagangan Terakhir', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(25, 36, 'Tidak ada hari perdagangan Terakhir', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(20, 36, 'Tidak ada hari perdagangan Terakhir', 1, 'J', 0, 1, '', '', true, 0, false, true, 0);
