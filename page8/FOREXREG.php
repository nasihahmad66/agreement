...
<title>FOREX REGULER</title></head>
<?php
include 'config.php';
session_start();
...
Trading Rules Kontrak Derivatif Forex dan Loco London Gold Regular<br/>
</h3><br/><hr><br>
...
<tr>
   ...
   <strong> &rArr;		Bank Central Asia (BCA) Sudirman - Jakarta</strong>
...
<tr>
	<td valign="top" width="10%" align="left" ><strong>Margin Deposit</strong></td>
...
<tr>
	...
	<td valign="top" align="justify" colspan="2">Minimum setoran awal untuk new account yang disetor oleh nasabah untuk dapat melakukan transaksi sebesar : $ 5.000 (New Account).
		</td>
</tr>
<tr>
	<td valign="top" width="10%" align="left" ><strong>Rate</strong></td>
	<td valign="top" align="justify" colspan="2"><table><tr><td>Fixed Rate</td><td>:</td><td> 1 USD = 10.000 IDR</td></tr><tr><td></td><td></td><td> 1 USD = 12.000 IDR</td></tr><tr><td>Floating Rate</td><td></td><td></td></tr></table></td></td>
</tr>
<tr>
...
<tr class="top">
	...
	<td align="center" colspan="4"><strong>Maximum Volume</strong></td>
	<td align="center" colspan="4"><strong>Margin Requirement per 1 lot Day Trade/Overnight :</strong></td>
	<td align="center" colspan="4"><strong>Margin Hedged per 1 lot</strong></td>
</tr>
<tr>
	...
	<td align="center" colspan="4">20 lot</td>
	<td align="center" colspan="4">USD. 1000.-</td>
	<td align="center" colspan="4">USD 200,-</td>
</tr>
<tr>
...
<tr>
	<td align="center" height="15px" colspan="4"></td>
...
<tr>
	...
	<td align="center" colspan="4">20 lot</td>
	<td align="center" colspan="4">USD. 1500.-</td>
	<td align="center" colspan="4">USD 300,-</td>
</tr>
...
<tr>
	...
	<ul>
		<li>Maksimal Open Posisi Dalam 1 Account 30 LOT </li>
...
Level / Spread antara harga yang diminta dan harga running adalah minimum 150 poin dari harga running untuk harga Forex dan Cross Rate,sedangkan untuk London Gold sebesar USD 2.</td>
</tr>
...
antara (10% < <i>Margin Level</i>< 100%)dari <i>Margin Requirement</i>.</td>
...
<form onSubmit="return validateForm()" method='post' action="functionforexreg.php" >
<table cellpadding="5" width="100%" class="tab-rule" border="1">
<tr>
