                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
									...
									$file=mysql_query("select * from namaid where status_verifikasi='Belum Terverifikasi' and status_pialang='Belum Selesai'");
								...
								<?php
									...
									echo '</tr></table>';
								$jum=mysql_query("select count(id) as 'jmlh' from namaid where status_verifikasi='Belum Terverifikasi' or status_pialang='Belum Selesai'");?>
