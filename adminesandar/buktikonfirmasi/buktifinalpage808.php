...
5. Overnight margin Index Saham Hongkong dimulai setelah sesi 2 berakhir dan Index Saham Jepang dimulai
    pada sesi 2.', 1, 'L', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 14, 'Margin Requirement per 1 lot Overnight: ', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 14, 'Rp. 16.000.000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 14, 'Rp. 15.000.000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 14, 'Rp. 18.200.000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 14, 'Rp. 16.000.000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 14, 'Rp. 16.000.000,-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 14, 'Rp. 18.200.000,-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(23, 0, '-                   ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 0, '-                   ', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
...
$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 70, 'Bulan Kontrak', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 70, 'F = Januari
G = Februari
H = Maret
J = April
K = Mei
...
U = September
Z = Desember', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 70, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 70, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 70, '-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);

$pdf->Ln(0);
$pdf->SetFont('helvetica', '', 10);
$pdf->MultiCell(45, 20, 'Transaksi Bulan Berikutnya', 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(24, 20, 'Dua hari sebelum hari Perdagangan Terakhir', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 20, 'Dua hari sebelum hari Perdagangan Terakhir', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 20, 'Dua hari sebelum hari Perdagangan Terakhir', 1, 'J', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(23, 20, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 20, '-', 1, 'C', 0, 0, '', '', true, 0, false, true, 0);
$pdf->MultiCell(21, 20, '-', 1, 'C', 0, 1, '', '', true, 0, false, true, 0);
