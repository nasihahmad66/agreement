...
$pdf->MultiCell(0, 0,'1. Maksimal Open Posisi Dalam 1 Account 20 LOT
...
2. Kontrak Berkala (Stock Index Rollover)
	   ...
	   open posisi yang masih ada dan open posisi (Original Price) tetap ada selama belum dilikuidasi nasabah.', 1, 'L', 0, 1, '', '', true, 0, false, true, 0);
$pdf->Ln(5);
